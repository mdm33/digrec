...
namespace :proiel do
  ...
  namespace :text do
    ...
    desc "Delete all existing source texts"
    task(:clear => :environment) do
      connection = ActiveRecord::Base.connection
      connection.execute "DELETE FROM audits WHERE 1=1;"
      connection.execute "ALTER TABLE audits AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM dependency_alignment_terms WHERE 1=1;"
      connection.execute "ALTER TABLE dependency_alignment_terms AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM import_sources WHERE 1=1;"
      connection.execute "ALTER TABLE import_sources AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM inflections WHERE 1=1;"
      connection.execute "ALTER TABLE inflections AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM lemmata WHERE 1=1;"
      connection.execute "ALTER TABLE lemmata AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM notes WHERE 1=1;"
      connection.execute "ALTER TABLE notes AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM semantic_tags WHERE 1=1;"
      connection.execute "ALTER TABLE semantic_tags AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM sentences WHERE 1=1;"
      connection.execute "ALTER TABLE sentences AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM slash_edges WHERE 1=1;"
      connection.execute "ALTER TABLE slash_edges AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM source_divisions WHERE 1=1;"
      connection.execute "ALTER TABLE source_divisions AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM sources WHERE 1=1;"
      connection.execute "ALTER TABLE sources AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM tokens WHERE 1=1;"
      connection.execute "ALTER TABLE tokens AUTO_INCREMENT=1;"
    end
  end
  ...
  namespace :semantic_relations do
    desc "Import semantic relations. Options: FILE=csv_file"
    task(:import => :myenvironment) do
      require 'import_export'
      file_name = ENV['FILE']
      raise "Missing argument" unless file_name
  ...
  namespace :semantic_tags do
    ...
    desc "Set up semantic tags."
    task(:setup => :myenvironment) do
      require 'import_export'
      connection = ActiveRecord::Base.connection
      connection.execute "DELETE FROM semantic_attributes WHERE 1=1;"
      connection.execute "ALTER TABLE semantic_attributes AUTO_INCREMENT=1;"
      connection.execute "DELETE FROM semantic_attribute_values WHERE 1=1;"
      connection.execute "ALTER TABLE semantic_attribute_values AUTO_INCREMENT=1;"
      connection.execute "INSERT INTO semantic_attributes (tag) VALUES ('animacy');"
      connection.execute "INSERT INTO semantic_attribute_values (semantic_attribute_id,tag) VALUES (1,'a');"
      connection.execute "INSERT INTO semantic_attribute_values (semantic_attribute_id,tag) VALUES (1,'i');"
      connection.execute "INSERT INTO semantic_attribute_values (semantic_attribute_id,tag) VALUES (1,'p');"
    end
  end
